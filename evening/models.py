...
class Staff(models.Model):
    ...
    soldier = models.OneToOneField(
        "Soldiers", on_delete=models.PROTECT, null=True, blank=True, verbose_name="Військовослужбовець"
    )
...
class Soldiers(models.Model):
    ...
    surname = models.CharField(max_length=50, blank=True, null=True, verbose_name="Фамілія")
    name = models.CharField(max_length=50, blank=True, null=True, verbose_name="Імʼя")
    fathers_name = models.CharField(max_length=50, blank=True, null=True, verbose_name="По батькові")
    callsign = models.CharField(max_length=50, blank=True, null=True, verbose_name="Позивний")
    rank = models.ForeignKey("Ranks", on_delete=models.PROTECT, blank=True, null=True, verbose_name="Звання")
    phone = models.CharField(max_length=13, blank=True, null=True, verbose_name="Телефон")
    birth_date = models.DateField(blank=True, null=True, default="2000-01-01", verbose_name="Дата народження")
    tax_number = models.CharField(max_length=15, unique=True, blank=True, null=True, verbose_name="ІПН")
    blood_type = models.CharField(max_length=15, blank=True, null=True, verbose_name="Группа крові")
    addres = models.CharField(max_length=255, blank=True, null=True, verbose_name="Адреса")
    complect_center = models.CharField(max_length=255, blank=True, null=True, verbose_name="Центр комплектаціі")
    mob_date = models.DateField(blank=True, null=True, default="2000-01-01", verbose_name="Дата мобілізаціі")
    children = models.CharField(max_length=50, blank=True, null=True, verbose_name="Діти")
    hight_s = models.CharField(max_length=50, blank=True, null=True, verbose_name="Зріст")
    size = models.CharField(max_length=50, blank=True, null=True, verbose_name="Розмір")
    boots_s = models.CharField(max_length=50, blank=True, null=True, verbose_name="Взуття")
    head_s = models.CharField(max_length=50, blank=True, null=True, verbose_name="Головний убор")
    photo = models.ImageField(blank=True, null=True, verbose_name="Фото")
    passport = models.CharField(max_length=50, blank=True, null=True, verbose_name="Паспорт")
...
class Weapons(models.Model):
    ...
    weapon_type = models.ForeignKey("WeaponsTypes", on_delete=models.PROTECT, verbose_name="Тип зброї", default=1)
    weapon_registration = models.BooleanField(default=True)
    year_manufacture = models.DateField(blank=True, null=True, default="2000-01-01", verbose_name="Рік виготовлення")
